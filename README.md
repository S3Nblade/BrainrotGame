...
An original top-down Roblox simulator built with Rojo and Luau. The project uses a flat pixel-tile world, sprite-ready brainrots, authoritative server gameplay, capture reveals, inventory placement, stand income, upgrades, rebirths, zones, boosts, and a collection index.
