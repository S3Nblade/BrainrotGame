...
An original top-down Roblox simulator built with Rojo and Luau. The project uses a flat pixel-tile world, sprite-ready brainrots, authoritative server gameplay, hold-to-attack combat, critical hits, capture combos, animated creature reveals, inventory placement, stand income, upgrades, rebirths, server-enforced zones, boosts, a persistent starter quest chain, live next-step coaching, mobile-styled action controls, daily rewards, capped offline earnings, and a collection index.
